...
[![Windows Builds](https://github.com/coin-or/CoinUtils/actions/workflows/windows-ci.yml/badge.svg?branch=releases/2.11.8)](https://github.com/coin-or/CoinUtils/actions/workflows/windows-ci.yml?query=branch%3Areleases/2.11.8)

[![Linux and MacOS Builds](https://github.com/coin-or/CoinUtils/actions/workflows/linux-ci.yml/badge.svg?branch=releases/2.11.8)](https://github.com/coin-or/CoinUtils/actions/workflows/linux-ci.yml?query=branch%3Areleases/2.11.8)
...
chmod u+x coinbrew
./coinbrew fetch CoinUtils@2.11.8
...
directory will be `./build/CoinUtils/2.11.8` by default. The doxygen documentation main file
