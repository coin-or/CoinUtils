...
class CoinWarmStartPrimalDual : public CoinWarmStart {
public:
...
protected:
   ...
   inline const CoinWarmStartVector& primalWarmStartVector() const
   { return primal_; }
   inline const CoinWarmStartVector& dualWarmStartVector() const
   { return dual_; }
    
private:
   ///@name Private data members
   //@{
   CoinWarmStartVector primal_;
...
class CoinWarmStartPrimalDualDiff : public CoinWarmStartDiff
{
...
private:
  ...
  /*!
      ...
      in the dual vector.
  */
  CoinWarmStartVectorDiff primalDiff_;
  CoinWarmStartVectorDiff dualDiff_;
} ;
