...
*/
    if (kcolx < kcex) {
      ...
      const CoinBigIndex kmi = presolve_find_col(icolx, mrstrt[row], mrstrt[row] + hinrow[row], hcol);
...
*/
    ...
    if (colLengths[tgtcolx] == 1 && colLengths[tgtcoly] == 1)
      continue;
    /*
...
*/
    ...
    if (singletonRow || prob->colProhibited2(tgtcoly))
      continue;
